...
init:
	mkdir -p /opt/DataRelease /opt/H0LiCOW /opt/CCcovariance /opt/Capse /opt/trained_emu /opt/planck /opt/bao_data
	...
	if [ ! -d /opt/bao_data/.git ]; then git clone https://github.com/CobayaSampler/bao_data.git /opt/bao_data; fi
